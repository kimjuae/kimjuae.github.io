...
function(){}};function Gd(a,b){var c=ld(a,b);c.vtp_permissionName=a;c.vtp_createPermissionError=Id;try{return md(c)}catch(d){return{assert:function(e){throw new sd(e,{},"Permission "+e+" is unknown.");},K:function(){for(var e={},f=0;f<arguments.length;++f)e["arg"+(f+1)]=arguments[f];return e}}}}function Id(a,b,c){return new sd(a,b,c)};var Md=!1;var Nd={};Nd.Ph=Oa('false');Nd.zg=Oa('true');var Od=Md,Pd=Nd.zg,Qd=Nd.Ph;
...
return null},ef=!1;if(J.querySelectorAll)try{var ff=J.querySelectorAll(":root");ff&&1==ff.length&&ff[0]==J.documentElement&&(ef=!0)}catch(a){}var bf=ef;var Fd={},R=null,vf=Math.random();Fd.B="GTM-P528B3";Fd.Nb="4f0";var wf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},xf="www.googletagmanager.com/gtm.js";var yf=xf,zf=null,Af=null,Bf=null,Cf="//www.googletagmanager.com/a?id="+Fd.B+"&cv=368",Df={},Ef={},Ff=function(){var a=R.sequence||0;R.sequence=a+1;return a};var Gf={},Hf=function(a,b){Gf[a]=Gf[a]||[];Gf[a][b]=!0},If=function(a){for(var b=[],c=Gf[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
e);if(a&&d){var m=kk(b.prefix),n=jk[m];n&&mk(m,n,b)}})};
var uk=function(a){return!(void 0===a||null===a||0===(a+"").length)},wk=function(a,b){var c;if(2===b.X)return a("ord",Ia(1E11,1E13)),!0;if(3===b.X)return a("ord","1"),a("num",Ia(1E11,1E13)),!0;if(4===b.X)return uk(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.X)c="1";else if(6===b.X)c=b.pd;else return!1;uk(c)&&a("qty",c);uk(b.Rb)&&a("cost",b.Rb);uk(b.transactionId)&&a("ord",b.transactionId);return!0},yk=function(a,b,c){function d(t,p,u){g.hasOwnProperty(t)||(p+="",f+=";"+t+"="+(u?p:xk(p)))}var e=
a.Uc,f=a.protocol;f+=a.uc?"//"+e+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";f+=";src="+xk(e)+(";type="+xk(a.Xc))+(";cat="+xk(a.qb));var g=a.ug||{};D(g,function(t,p){f+=";"+xk(t)+"="+xk(p+"")});if(wk(d,a)){uk(a.Ac)&&d("u",a.Ac);uk(a.zc)&&d("tran",a.zc);d("gtm",Yj());!1===a.Wf&&d("npa","1");var k=!0;if(a.Tc&&k){var l=rk("dc",a.Qa);l&&l.length&&d("gcldc",l.join("."));var m=rk("aw",a.Qa);m&&m.length&&d("gclaw",m.join("."));var n=sk();n&&d("gac",n);nk({prefix:a.Qa,wb:a.qg,domain:a.pg,flags:a.gi});var r=jk[kk(a.Qa)];r&&d("auiddc",r)}uk(a.ld)&&d("prd",a.ld,!0);D(a.vd,function(t,p){d(t,p)});f+=b||"";uk(a.mc)&&d("~oref",a.mc);a.uc?Se(f+"?",a.D):Te(f+"?",a.D,a.C)}else O(a.C)},xk=encodeURIComponent,
zk=function(a,b){yk(a,b)};var ol={},pl=["G","GP"];ol.bf="";var ql=ol.bf.split(",");function rl(){var a=R;return a.gcq=a.gcq||new sl}
...
Z.b.flc=[],function(){function a(b,c){c=c?c.slice(0,-1):void 0;zk(b,c)}(function(b){Z.__flc=b;Z.__flc.g="flc";Z.__flc.h=!0;Z.__flc.priorityOverride=0})(function(b){var c=!b.hasOwnProperty("vtp_enableConversionLinker")||b.vtp_enableConversionLinker,d=Mo(b.vtp_customVariable||[],"key","value")||{},e={qb:b.vtp_activityTag,Tc:c,Qa:b.vtp_conversionCookiePrefix||void 0,Rb:void 0,X:{UNIQUE:3,SESSION:4}[b.vtp_ordinalType]||2,Uc:b.vtp_advertiserId,Xc:b.vtp_groupTag,C:b.vtp_gtmOnFailure,D:b.vtp_gtmOnSuccess,
mc:b.vtp_useImageTag?void 0:b.vtp_url,protocol:"",pd:void 0,uc:!b.vtp_useImageTag,sessionId:b.vtp_sessionId,zc:b.vtp_transactionVariable,transactionId:void 0,Ac:b.vtp_userVariable,vd:d};if(b.vtp_enableAttribution){var f=b.vtp_attributionFields||[];if(f.length){W("//www.gstatic.com/attribution/collection/attributiontools.js",function(){a(e,X("google_attr").build([Mo(f,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(e)})}();Z.b.c=["google"],function(){(function(a){Z.__c=a;Z.__c.g="c";Z.__c.h=!0;Z.__c.priorityOverride=0})(function(a){return a.vtp_value})}();
...
Z.b.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:Un()}function b(f,g){Ue(f,"hashchange",function(k){var l=a(k);g({source:"hashchange",state:null,url:Wn(l),P:Vn(l)})})}function c(f,g){Ue(f,"popstate",function(k){var l=a(k);g({source:"popstate",state:k.state,url:Wn(l),P:Vn(l)})})}function d(f,g,k){var l=g.history,m=l[f];if(Ea(m))try{l[f]=function(n,r,t){m.apply(l,[].slice.call(arguments,0));k({source:f,state:n,url:Wn(Un()),
P:Vn(Un())})}}catch(n){}}function e(){var f={source:null,state:X("history").state||null,url:Wn(Un()),P:Vn(Un())};return function(g){var k=f,l={};l[k.source]=!0;l[g.source]=!0;if(!l.popstate||!l.hashchange||k.P!=g.P){var m={event:"gtm.historyChange","gtm.historyChangeSource":g.source,"gtm.oldUrlFragment":f.P,"gtm.newUrlFragment":g.P,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":g.state};m["gtm.oldUrl"]=f.url,m["gtm.newUrl"]=g.url;
f=g;Yn(m)}}}(function(f){Z.__hl=f;Z.__hl.g="hl";Z.__hl.h=!0;Z.__hl.priorityOverride=0})(function(f){var g=X("self");if(!bo("hl")){var k=e();b(g,k);c(g,k);d("pushState",g,k);d("replaceState",g,k);co("hl")}O(f.vtp_gtmOnSuccess)})}();
...
Z.b.hid=["google"],function(){(function(a){Z.__hid=a;Z.__hid.g="hid";Z.__hid.h=!0;Z.__hid.priorityOverride=0})(function(){return hn.Jb})}();
